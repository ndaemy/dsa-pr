...
const departments: Department[] = [
  {
    ...
    desc:
      ...
      "\n" +
      "밝은 분위기에서 기억에 남는 즐거운 봉사가 하고 싶은 친구들을 찾습니다 .\n" +
      "\n" +
      "예배를 준비해보고 싶었던 분들 🫵🏻\n" +
      "행사를 기획해보고 싶었던 분들 🫵🏻\n" +
      "지금 당장 학생회로 연락주세요 !\n" +
      "\n" +
      "면접 날짜 : 12월 18일 , 12월 25일\n" +
      "\n" +
      "🙋🏻‍♂️ 담임 교사 : 임동현\n" +
      "📞 010-9644-0356",
    color: "pink",
  ...
  },
  {
    ...
    desc:
      "안녕하세요 \n" +
      "찬양으로 하나님과 교회를 섬기고 있는\n" +
      "고등부 빛마을 찬양대 입니다\n" +
      "\n" +
      "매주 주일 9시 1부 예배와\n" +
      "11시 2부 예배의 성가를 준비하고 있습니다\n" +
      "\n" +
      "지휘자 선생님 지도아래 소프라노 및 알토\n" +
      "테너, 베이스 그리고 악기연주(앙상블) 등 각\n" +
      "파트별로 연습이 진행되어지고 있습니다\n" +
      "\n" +
      "찬양을 함께하고 사랑하는\n" +
      "기쁜 마음으로 함께할 학생들의 많은 지원바랍니다\n" +
      "\n" +
      "------------------------------------------\n" +
      "지원안내 및 오디션 일정 입니다\n" +
      "\n" +
    ...
    <div className="flex place-content-center">
      <div className="w-full max-w-2xl px-4 py-24">
        ...
        <h3 className="text-lg text-center text-neutral-400 font-normal leading-normal mb-12">
          지원을 원하는 학생들은 중등교구 예배실 앞에 비치되어 있는 지원서를 작성한 후
          <br />
          지원을 희망하는 부서 선생님께 연락하시기 바랍니다.
        </h3>
        ...
        <div className="hidden flex justify-center gap-2 mt-12">
          {colors.map(color => (
